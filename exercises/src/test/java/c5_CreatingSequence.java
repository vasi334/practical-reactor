...
public class c5_CreatingSequence {
    ...
    public void repeat() {
        ...
        Callable<Integer> incrementAndReturn = counter::incrementAndGet;

        Flux<Integer> repeated = Flux.defer(() -> Mono.fromCallable(incrementAndReturn)).repeat(9).take(10); //todo: change this line
